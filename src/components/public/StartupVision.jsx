        ...
        <section id="startup" className="lazy-section py-32 px-4 relative overflow-hidden bg-white border-t-2 border-[#18112E]">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl sm:text-5xl md:text-8xl font-black text-[#18112E] tracking-tighter uppercase leading-[0.9] mb-8">
                        DevConnect <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFB800] to-[#ffcc33]">Platform.</span>
                    </h2>

                    <p className="text-neutral-500 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed font-bold">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {pillars.map((pillar, i) => (
                        <motion.div
                            ...
                            className="bg-[#F8F9FA] border-2 border-[#18112E] shadow-[6px_6px_0_#18112E] rounded-[32px] p-6 sm:p-8 hover:bg-[#FFB800] transition-colors group relative overflow-hidden cursor-default"
                        >
